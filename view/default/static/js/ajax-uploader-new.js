...
(function () {
  var defaultSettings = {
    ...
    extensions: null,
    mimeTypes: null,
    tooSmall: __('Минимальный размер файла - {limit}'),
    tooBig: __('Максимальный размер файла - {limit}'),
    wrongExtension: __('Разрешены только: {extensions}'),
    wrongMimeType: __('Разрешены только: {mimeTypes}'),
    onlyImage: false,
    maxHeight: null,
    maxWidth: null,
    minHeight: 1,
    minWidth: 1,
    notImage: __('Файл не является изображением.'),
    overHeight: __('Высота максимум - {limit} пикс.'),
    overWidth: __('Ширина максимум - {limit} пикс.'),
    underHeight: __('Высота минимум - {limit} пикс.'),
    underWidth: __('Ширина минимум - {limit} пикс.'),
    tooMany: __('Слишком много файлов.'),
    alreadyExists: __('Такой файл уже выбран'),
